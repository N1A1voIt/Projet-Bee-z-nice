...
@Component({
selector: 'app-foodorder',standalone:true,imports: [FormsModule, NgFor, CommonModule, NInputComponent, NSelectComponent, NgxPaginationModule, ModalComponentComponent, NTableComponent, SubmitButtonComponent],
...
ordertimeValue:datetime-local|null = null;
